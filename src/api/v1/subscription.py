...
def get_user_subscriptions(user: Annotated[User, Depends(get_current_user)],
...
def subscribe_channel(user: Annotated[User, Depends(get_current_user)],
                      service: Annotated[SubscriptionService, Depends(get_subscription_service)],
...
def unsubscribe_channel(user: Annotated[User, Depends(get_current_user)],
                        service: Annotated[SubscriptionService, Depends(get_subscription_service)],
                        channel_id: int):
...
def update_subscription(user: Annotated[User, Depends(get_current_user)],
                        service: Annotated[SubscriptionService, Depends(get_subscription_service)],
...
def get_subscription_groups(user: Annotated[User, Depends(get_current_user)],
                            service: Annotated[SubscriptionService, Depends(get_subscription_service)]):
    return service.get_subscription_groups(user)


@router.post("/groups", response_model=GroupDetail)
def create_subscription_group(data: GroupCreate,
...
def update_subscription_group(id: int,
                              data: GroupCreate,
                              user: Annotated[User, Depends(get_current_user)],
                              service: Annotated[SubscriptionService, Depends(get_subscription_service)]):
...
def delete_subscription_group(id: int,
                              user: Annotated[User, Depends(get_current_user)],
                              service: Annotated[SubscriptionService, Depends(get_subscription_service)]):
...
def add_subscription_to_group(id: int,
                              subscription_id: int,
                              user: Annotated[User, Depends(get_current_user)],
                              service: Annotated[SubscriptionService, Depends(get_subscription_service)]):
...
def remove_subscription_from_group(id: int,
                                   subscription_id: int,
                                   user: Annotated[User, Depends(get_current_user)],
                                   service: Annotated[SubscriptionService, Depends(get_subscription_service)]):
