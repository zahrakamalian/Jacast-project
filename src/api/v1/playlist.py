...
def get_user_playlists(user: Annotated[User, Depends(get_current_user)],
...
def get_playlist_detail(id: int,
...
def update_playlist(id: int, data: PlaylistUpdate,
                    user: Annotated[User, Depends(get_current_user)],
                    service: Annotated[PlaylistService, Depends(get_playlist_service)]):
...
def add_episode_to_playlist(id: int,
...
def remove_episode_from_playlist(id: int,
                                 episode_id: int,
                                 user: Annotated[User, Depends(get_current_user)],
                                 service: Annotated[PlaylistService, Depends(get_playlist_service)]):
...
def reorder_episodes(id: int,
                     data: ReorderEpisodesRequest,
                     user: Annotated[User, Depends(get_current_user)],
                     service: Annotated[PlaylistService, Depends(get_playlist_service)]):
...
def create_playlist_share_link(id: int,
                               user: Annotated[User, Depends(get_current_user)],
                               service: Annotated[PlaylistService, Depends(get_playlist_service)]):
...
def redirect_playlist_share(token: str,
                            service: Annotated[PlaylistService, Depends(get_playlist_service)]):
...
def update_collaboration_status(id: int,
...
def remove_collaborator(id: int,
                        user_id: int,
                        user: Annotated[User, Depends(get_current_user)],
                        service: Annotated[PlaylistService, Depends(get_playlist_service)]):
